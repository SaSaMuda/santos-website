const projectsData = [
    ...
    },
    {
        ...
        description: {
            en: "Detailed pyrography (wood burning) art applied to custom table tennis paddles.",
            es: "Arte detallado de pirografía (grabado en madera) aplicado a paletas de tenis de mesa personalizadas.",
            de: "Detaillierte Brandmalerei (Pyrographie) auf massgefertigten Tischtennisschlägern."
        },
        images: [
            "assets/image-1766225730992.jpg",
            "assets/image-1766254762408.jpg",
            "assets/IMG-20260525-WA0008.jpg",
            "assets/image-1766254791137.jpg",
            "assets/image-1766254799770.jpg"
        ]
    },
    {
        id: "jewelry",
        title: {
            ...
            es: "Colección de Joyería",
            de: "Schmuckkollektion"
        },
        description: {
            en: "Handcrafted jewelry pieces combining fine materials and intricate designs.",
            es: "Piezas de joyería hechas a mano que combinan materiales finos y diseños intrincados.",
            de: "Handgefertigte Schmuckstücke, die edle Materialien und filigrane Designs kombinieren."
        },
        images: [
            "assets/20251218_162714.jpg",
    ...
    },
    {
        id: "electronics",
        title: {
            en: "Electronics & Upcycling",
            es: "Electrónica y Reciclaje",
            de: "Elektronik & Upcycling"
        },
        description: {
            en: "Repairing and repurposing electronics to give them a second life with improved functionality.",
            es: "Reparación y reutilización de aparatos electrónicos para darles una segunda vida con una funcionalidad mejorada.",
            de: "Reparatur und Umnutzung von Elektronik, um ihr ein zweites Leben mit verbesserter Funktionalität zu geben."
        },
        images: [
    ...
    },
    {
        ...
        description: {
            en: "A collection of small works in progress and various experiments.",
            es: "Una colección de pequeños trabajos en curso y varios experimentos.",
            de: "Eine Sammlung kleiner Arbeiten in Arbeit und verschiedener Experimente."
        },
        images: [
